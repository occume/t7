...
//  一、<input name="dateText" type="text"><input type="button" value="选择日期" onclick="setday(this,document.all.dateText)">
//  二、<input name="dateText" type="text" onfocus="setday(this)">
