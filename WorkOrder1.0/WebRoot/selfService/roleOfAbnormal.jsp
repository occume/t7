...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<title>在线自助服务专区－游戏问题－ 角色异常 </title>
		...
		<script type="text/javascript" src="../include/roleOfAbnormal.js"></script>
	...
	<body>
		<div class="main">
					...
					<div class="box">
						<div class="mF_tab">
							...
							<ul class="btn">
								...
								<li><a href="/selfService/userWOList?preURL=roleOfAbnormal">我的咨询记录</a></li>
							</ul>

							<ul class="cont">
								<!--提问表单  开始-->
								<li>
									<form name="form" id="roleAbnormalForm" action="/wo/save_abnormal" method="post" enctype="multipart/form-data">
										<div class="formcont">
											<h1>
												在线自助服务专区－游戏问题－
												<span>角色异常</span>
		  ...
		  <input type="hidden" name="userInfo.accountname" value="<s:property value="#session.member.username"/>"/>
										...
										<div class="buttonBox">
											<div class="buttonYes">
												<a href="javascript:void(0)"  onclick="register(this);" tabindex="10" id="submit_btn">出错啦!</a>
											</div>
											<div class="buttonNo">
												<!-- a href="javascript:void(0)" onclick="javascript:document.roleAbnormalForm.reset();return false;" tabindex="11">重填</a>   -->
											</div>
											<div class="clear"></div>
										</div>
									</form>
