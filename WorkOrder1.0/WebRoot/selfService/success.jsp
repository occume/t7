		...
		<div class="mF_tab">
			...
			<ul class="cont">
				...
				<!--使用登陆密码修改  start here-->
						  ...
						  <div class=formcont>
						    	<div style="margin:50px 0px 0px 210px;font-size:16px;"><img src="../images/face.png" alt="success" />您已成功提交问题！请耐心等候回复结果 ^-^!</div>
						    	<s:if test="#parameters.issueType!=null">
						    		<div style="margin:10px 0px 0px 110px;font-size:16px;color:#008080">
						    		温馨提示：此问题需要数据查询，一般会在3个工作内给出查询结果，感谢您的支持！
						    		</div>
						    	</s:if>
