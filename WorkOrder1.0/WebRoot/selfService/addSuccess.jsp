  ...
  <head> 
	...
	<script >
	   // $(document).ready(function() {
	    location.href="/wo/get_workOrderDetail?woId=<s:property value='@com.hy.wo.util.MyUtil@paramEncode(woId)'/>";
		 //   var seconds =4;  
		...
		<div class="mF_tab">
			...
			<ul class="cont">
				...
				<!--使用登陆密码修改  start here-->
						  ...
						  <div class=formcont>
						    	<div style="margin:50px 0px 0px 210px;font-size:16px;"><img src="../images/face.png" alt="success" />您已成功补充该问题！请耐心等候回复结果 ^-^!</div>
						    	
						    	
						  	<div class="buttonNotes"><a href="/wo/get_workOrderDetail?woId=<s:property value="@com.hy.wo.util.MyUtil@paramEncode(woId)"/>"><span id="sec">5</span>秒后自动返回该问题详细页面</a></div>
						  </div>
