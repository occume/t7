...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="../include/others.js"></script>
					...
					<div class="box">
						<div class="mF_tab">
							...
							<ul class="btn">
								...
								<li><a href="/selfService/userWOList?preURL=others">我的咨询记录</a></li>
							</ul>
							...
							<ul class="cont">
								...
								<li>
									<form name="plugAbuseForm" id="plugAbuseForm"
										action="/wo/save_others" method="post"
										...
										<div class="formcont">
											...
											<div class="formrigcont">
												<input type="text" id="username" name="userInfo.username" class="input180"
										...
										<div class="formcont">
											...
											<div class="forminputfile">
												<input name="upload" type="file" class="input500" tabindex="6" />
											</div>
											<div class="clear"></div>
										</div>
										...
										<div class="buttonBox">
											<div class="buttonYes">
												<a onclick="register(this);" tabindex="9" id="submit_btn">随便问问</a>
											</div>
											<div class="buttonNo">
												<!--a onclick="javascript:plugAbuseForm.reset();return false;" tabindex="10">重填</a -->
											</div>
											<div class="clear"></div>
										</div>
									</form>
